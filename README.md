...
This repository contains the codes of the [Backend Master Class](https://bit.ly/backendmaster) course by [TECH SCHOOL](https://bit.ly/m/Ian-Balijawa).

![Backend master class](backend-master.png)

You can also find it on Udemy at [this link](https://bit.ly/backendudemy).

And don't hesitate to [join Tech School's Discord group](https://bit.ly/Ian-Balijawadc) to chat directly with me and other students.
...
- Access the DB documentation at [this address](https://dbdocs.io/Ian-Balijawa.guru/simple_bank). Password: `secret`
